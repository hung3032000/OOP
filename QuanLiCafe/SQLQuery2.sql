CREATE DATABASE QuanLyQuancoffe1
GO

USE QuanLyQuancoffe1
GO
...
(
	...
	status NVARCHAR(100) NOT NULL DEFAULT N'Trống'	-- Tr?ng || Có ng??i
)
GO
...
UPDATE dbo.TableFood SET status = N'Trống',name = N'Bàn 22' WHERE id = N'21'