...
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Cà phê espresso', -- name - nvarchar(100)
          1, -- idCategory - int
          42000.0  -- price - float
          )
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Freze cà phê phin', -- name - nvarchar(100)
          2, -- idCategory - int
          42000.0  -- price - float
          )
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Freze không cà phê', -- name - nvarchar(100)
          2, -- idCategory - int
          35000.0  -- price - float
          )
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'Trà sen vàng', -- name - nvarchar(100)
          3, -- idCategory - int
          35000.0  -- price - float
          )
INSERT dbo.Food
        ( name, idCategory, price )
VALUES  ( N'BÁnh mì th?t n??ng', -- name - nvarchar(100)
          4, -- idCategory - int
          20000.0  -- price - float
          )
INSERT dbo.Food
...
AS 
BEGIN
	SELECT t.name AS [Tên bàn], b.totalPrice AS [T?ng ti?n], DateCheckIn AS [Ngày vào], DateCheckOut AS [Ngày ra]
